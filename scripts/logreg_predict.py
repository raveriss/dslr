...
def parse_command_line_arguments():
    ...
    Returns:
        ...
        trained_parameter_json_file_path et output_csv_path.
    """
...
def predict_house_names(students_discipline_scores_with_bias, house_discipline_weights_with_bias, house_name_by_code):
    """
...
def main():
    ...
    try:
        ...
        predicted_house_names_for_all_students = predict_house_names(students_discipline_scores_with_bias, house_discipline_weights_with_bias, house_name_by_code)
